...
namespace SubscriptionApi.Controllers
{
    ...
    [ApiController]
    [Route("api/restricciones-dominio")]
    ...
    public class RestriccionesDominioController: ControllerBase
    {
        ...
        public RestriccionesDominioController(AppDbContext context, IMapper mapper,
        ...
        public async Task<ActionResult> Put(int id, RestriccionActualizacionDto actualizacionDto)
        {
            ...
            var restriccion = await _context.RestriccionesDominio
                .Include(rd => rd.Llave)
            ...
            restriccion.Dominio = actualizacionDto.Valor;
            await _context.SaveChangesAsync();
